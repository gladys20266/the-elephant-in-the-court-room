...
const contactSeo = {
  ...
  description:
    'Contact The Elephant In The Court Room campaign with questions, media inquiries, support requests, or messages about The Death of the Contract and the ongoing legal advocacy effort.',
  canonical: '/contact',
