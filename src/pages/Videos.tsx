    ...
    <section className="section-padding bg-off-white min-h-screen">
      ...
      >
        ...
        <p className="reveal-child text-body text-charcoal max-w-3xl mb-12 leading-8">
           This documentary introduces the story behind <strong>The Death of the Contract</strong>.
           It explains the events surrounding the lease-to-own agreement, the years of
           litigation that followed, and why Leo and Olga continue to seek specific
           performance of the original contract.
        </p>

        <div className="reveal-child bg-white rounded-3xl shadow-2xl border border-gray-200 my-16 p-6">
          ...
          <div className="p-8">
            ...
            <p className="text-charcoal leading-8 text-lg">
               ...
               introduces the people, events, and evidence at the heart of
               the case.
            </p>
        ...
        <div className="reveal-child mt-24">
...
>
  <div className="flex items-start gap-7">
    ...
    <div className="flex h-20 w-20 items-center justify-center rounded-full bg-purple/5 flex-shrink-0">
    ...
    <div>
      ...
      <p className="text-charcoal leading-8 text-lg">
        Additional documentaries, court updates, supporting evidence,
        interviews, and campaign videos will be published here as they
        become available. This page will continue to document the progress
        of the case and important developments.
      </p>
