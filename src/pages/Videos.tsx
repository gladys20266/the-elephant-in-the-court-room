            ...
            <div className="flex items-start gap-7">
              ...
              <div>
                ...
                <p className="text-charcoal leading-8 text-lg">
                  ...
                  interviews, and campaign videos will be published here as
                  they become available. This page will continue to document
                  the progress of the case and important developments.
                </p>
              </div>
            </div>
          </div>
