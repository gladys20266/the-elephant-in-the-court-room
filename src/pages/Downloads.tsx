...
const courtDocuments = [
  ...
  {
    title: 'Court Orders',
    description: 'Important court orders and rulings issued throughout the case.',
    icon: FileText,
    href: '/downloads/court-orders.pdf',
  },
  {
    title: 'Docket History',
    description: 'A chronological record of filings, hearings, and court activity.',
    icon: History,
...
const contractDocuments = [
  {
    ...
    description: 'The original Lease-to-Own Agreement signed by both parties.',
    icon: ScrollText,
    href: '/downloads/lease-to-own-agreement.pdf',
  },
  {
    title: 'Supporting Agreements',
    description: 'Additional agreements and related legal documents supporting the case.',
    icon: Handshake,
    href: '/downloads/supporting-agreements.pdf',
  },
  {
    title: 'Contract Amendments',
    description: 'Amendments or modifications made to the original agreement.',
    icon: FileSignature,
...
const evidenceDocuments = [
  ...
  },
  {
    ...
    description: 'Financial documents supporting the investment made into the property.',
    icon: Receipt,
    href: '/downloads/financial-records.pdf',
  },
  {
    title: 'Supporting Evidence',
    description: 'Additional evidence supporting the facts presented in this case.',
    icon: Archive,
...
const petitionDocuments = [
  ...
  },
  {
    ...
    description: 'Correspondence between the parties and legal representatives.',
    icon: Send,
    href: '/downloads/legal-correspondence.pdf',
  },
  {
    title: 'Public Communications',
    description: 'Public communications and related campaign materials.',
    icon: Mailbox,
      ...
      <section className="mx-auto max-w-7xl px-6 py-20">
        ...
        <div className="mb-20">
          <div className="rounded-3xl border border-lime-300 bg-gradient-to-r from-lime-50 to-white p-8 shadow-xl">
            ...
            <h2 className="mb-4 text-4xl font-black text-purple-800">
              Case Summary & Timeline
            </h2>

            <p className="max-w-3xl text-lg leading-8 text-gray-600">
              A concise overview of the legal dispute, timeline, court proceedings,
              and supporting evidence. This document is recommended for anyone who
